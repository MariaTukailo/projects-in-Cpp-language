...
int main()
{
    ...
    for (int i = 0; i < numberArray; i++)
    {
        ...
        cin >> array;                                                                                 //ввод элементов массива
        ...
        {
            intersection = intersection * array;                                                                    //нахождение пересечения при помощи перегрузки оператора *=
       ...
       cout <<intersection;                                                                          //вывод пересечения с помощью перегрузки оператора ввода
