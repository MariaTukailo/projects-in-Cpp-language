...
public:
	...
	friend ifstream& operator>>(ifstream& in, Bird& obj);
	friend ofstream& operator<<(ofstream& out, Bird& obj);

	friend fstream& operator<<(fstream& out, const Bird& resident);
	friend fstream& operator>>(fstream& in,Bird& resident);
