...
public:
	...
	friend ifstream& operator>>(ifstream& in, Mammal& obj);
	friend ofstream& operator<<(ofstream& out, Mammal& obj);
	
	friend fstream& operator<<(fstream& out, const Mammal& resident);
	friend fstream& operator>>(fstream& in, Mammal& resident);
